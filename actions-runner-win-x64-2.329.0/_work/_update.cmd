...
set rootfolder=D:\hoilday\rain\actions-runner-win-x64-2.329.0
set existrunnerversion=2.329.0
set downloadrunnerversion=2.330.0
set logfile=D:\hoilday\rain\actions-runner-win-x64-2.329.0\_diag\SelfUpdate-20251221-064616.log
...
if %restartinteractiverunner% equ 1 (
  ...
  endlocal
  start "Actions Runner" cmd.exe /k "D:\hoilday\rain\actions-runner-win-x64-2.329.0\run.cmd"
) else (
  endlocal
)
