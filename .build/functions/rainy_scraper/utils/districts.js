// COMPREHENSIVE LIST OF ALL INDIAN STATES, UTS, AND DISTRICTS
// This map allows us to filter: If "Tamil Nadu" (Parent) and "Chennai" (Child) 
// appear in the same sentence, we only report "Chennai" (Specifics > General).
...
const DISTRICTS_BY_STATE = {
    "Andhra Pradesh": [
        ...
        "Nellore", "Sri Sathya Sai", "Tirupati", "Visakhapatnam", "Vizianagaram", "West Godavari", 
        "YSR Kadapa"
    ],
    "Arunachal Pradesh": [
    ...
    "Assam": [
        ...
        "South Salmara-Mankachar", "Tamulpur", "Tinsukia", "Udalguri", "West Karbi Anglong", "Guwahati"
    ],
    "Bihar": [
    ...
    "Chhattisgarh": [
        ...
        "Narayanpur", "Raigarh", "Raipur", "Rajnandgaon", "Sarangarh-Bilaigarh", "Shakti", "Sukma", 
        "Surajpur", "Surguja"
    ],
    ...
    "Kerala": [
        ...
        "Malappuram", "Palakkad", "Pathanamthitta", "Thiruvananthapuram", "Thrissur", "Wayanad", "Kochi"
    ],
    "Madhya Pradesh": [
        ...
        "Vidisha", "Niwari", "Mauganj", "Maihar", "Pandhurna"
    ],
    "Maharashtra": [
...
// Auto-generate the flat list for searching
const FLAT_LIST = [
    ...Object.keys(DISTRICTS_BY_STATE), 
    ...Object.values(DISTRICTS_BY_STATE).flat()
];

module.exports = { FLAT_LIST, DISTRICTS_BY_STATE };