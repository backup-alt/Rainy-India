...
function updateSubmitButton() {
    const dataTypeSelected = document.getElementById('data-type').value;
    const stateSelected = stateSelect.value;
    const districtSelected = districtSelect.value;
    
    if (dataTypeSelected && stateSelected && districtSelected) {
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('data-type').addEventListener('change', updateSubmitButton);
